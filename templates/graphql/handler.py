...
def list_items() -> list[dict]:
    ...
    """
    try:
        # Use TypeAdapter for batch validation and serialization to improve performance
        items = item_adapter.validate_python(repository.list_items())
        return item_adapter.dump_python(items, by_alias=True, exclude_none=True)  # type: ignore
    except Exception as error:
