...
from templates.bedrock_agent.models import AgentItem
...
class Handler:
    """Handles Bedrock Agent events using function-based actions."""

    def __init__(self, repository: Repository) -> None:
        """Initialize the handler with a repository.

        Args:
            repository: The repository used to store and retrieve items.
        """
    ...
    @tracer.capture_method
    def create_item(self, item_id: str, name: str, description: str | None = None) -> dict:
        """Create a new item.
        ...
        item = AgentItem(id=item_id, name=name, description=description)
...
def create_item(item_id: str, name: str, description: str | None = None) -> dict:
    ...
    return handler.create_item(item_id, name, description)
